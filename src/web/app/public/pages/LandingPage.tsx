  ...
  const testimonials = [
    {
      name: "Sarah K.",
      role: "Grad student",
      text: "Finally stopped the awkward 'hey can you pay me back' texts. Splitly makes it effortless.",
      avatar: "SK",
    },
    {
      name: "Marcus T.",
      role: "Software engineer",
      text: "Used it for a 3-week Euro trip with 8 friends. Balanced to the cent with zero drama.",
      avatar: "MT",
    },
    {
      name: "Priya R.",
      role: "Project manager",
      text: "We use it for our shared apartment. Rent, groceries, utilities all in one place.",
      avatar: "PR",
    },
  ];
    ...
    <div className="bg-[#F6FBF8]">
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-24 lg:pt-28 lg:pb-32">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <div
              className="inline-flex items-center gap-2 bg-[#D1FAE5] text-[#065f46] px-3 py-1.5 rounded-full text-sm mb-6"
            ...
            <div className="mt-10 flex items-center gap-6">
              <div className="flex -space-x-2">
                {["#7EDDBA", "#93C5FD", "#FCA5A5", "#FCD34D", "#C4B5FD"].map(
                  (color, index) => (
                    <div
                      key={color}
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="relative bg-white rounded-3xl shadow-xl p-6 border border-[#E5E7EB]">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <p
                    className="text-xs text-[#9CA3AF] uppercase tracking-wider"
                    style={{ fontWeight: 600 }}
                  >
                    Group Balance
                  </p>
                  <p
                    className="text-3xl text-[#111827] mt-1"
              ...
              <div className="space-y-3 mb-6">
                {[
                  ...
                  <div
                    key={person.name}
                    className="flex items-center gap-3 bg-[#F9FAFB] rounded-xl px-3 py-2.5"
                  >
                    <div
              ...
              <div
                className="bg-[#16A34A] text-white text-center py-3 rounded-xl text-sm"
                style={{ fontWeight: 600 }}
              >
      ...
      <section id="features" className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <div
              className="inline-flex items-center gap-2 bg-[#F0FAF5] text-[#16A34A] px-3 py-1.5 rounded-full text-sm mb-4"
              style={{ fontWeight: 500 }}
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map(({ icon: Icon, title, desc, color, iconColor }) => (
              <div
                key={title}
                className="bg-[#F6FBF8] rounded-2xl p-6 hover:shadow-md transition-all border border-[#E5E7EB] group hover:-translate-y-0.5"
              >
                <div
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map(({ name, role, text, avatar }) => (
              <div
                key={name}
                className="bg-[#F6FBF8] rounded-2xl p-6 border border-[#E5E7EB]"
              >
                ...
                <p
                  className="text-[#374151] text-sm mb-5"
                  style={{ lineHeight: 1.7 }}
                >
                  "{text}"
                </p>
                <div className="flex items-center gap-3">
                  <div
                    className="w-9 h-9 rounded-full bg-[#7EDDBA] flex items-center justify-center text-xs text-[#065f46]"
                    style={{ fontWeight: 700 }}
                  >
                    {avatar}
                  </div>
              ...
              >
                <p
                  className={`text-sm mb-1 ${
                    primary ? "text-[#A7F3D0]" : "text-[#6B7280]"
                  }`}
                  style={{ fontWeight: 500 }}
                >
                  {name}
                ...
                <div className="flex items-end gap-1 mb-5">
                  ...
                  <span
                    className={`mb-1 text-sm ${
                      primary ? "text-[#A7F3D0]" : "text-[#9CA3AF]"
                    }`}
                  >
                    {period}
                  </span>
                    ...
                    <li key={feature} className="flex items-center gap-2.5 text-sm">
                      <Check
                        className={`w-4 h-4 flex-shrink-0 ${
                          primary ? "text-[#A7F3D0]" : "text-[#16A34A]"
                        }`}
                      />
                      <span
                        className={primary ? "text-[#D1FAE5]" : "text-[#374151]"}
                      >
                        {feature}
                      </span>
                    </li>
      ...
      <section className="bg-[#16A34A] py-20">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-[#A7F3D0] mb-8" style={{ lineHeight: 1.7 }}>
            {t.joinUsers}
          </p>
          <button
            onClick={() => navigate("/register")}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm text-[#9CA3AF]">
              {[t.privacy, t.terms, t.helpCenter, t.contact].map((label) => (
                <a
                  key={label}
                  href="#"
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-8 h-8 bg-[#F6FBF8] rounded-lg flex items-center justify-center text-[#6B7280] hover:text-[#111827] hover:bg-[#F0FAF5] transition-colors"
              >
          ...
          <div className="mt-8 pt-6 border-t border-[#E5E7EB] text-center text-xs text-[#9CA3AF]">
            Copyright 2026 Splitly Inc. Made with care for fair friends.
          </div>
        </div>
      </footer>
    </div>
