      ...
      {mobileOpen ? (
        <div className="md:hidden border-t border-[#E5E7EB] bg-white px-4 pb-4 pt-2 flex flex-col gap-1">
          ...
          <div className="border-t border-[#E5E7EB] mt-2 pt-2 flex flex-col gap-2">
            <button
              onClick={() => nav("/login")}
              className="px-4 py-2.5 text-sm text-[#374151] rounded-xl border border-[#E5E7EB] hover:bg-[#F9FAFB]"
              style={{ fontWeight: 500 }}
            >
              {t.login}
            </button>
            <button
              onClick={() => nav("/register")}
              className="px-4 py-2.5 bg-[#16A34A] text-white text-sm rounded-xl hover:bg-[#15803d]"
              style={{ fontWeight: 600 }}
            >
              {t.signupFree}
            </button>
