...
import { AdminSettlementDisputeDetailPage } from "../pages/AdminSettlementDisputeDetailPage";
...
export const adminRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: "settlement-disputes/:disputeId", element: <AdminSettlementDisputeDetailPage /> },
