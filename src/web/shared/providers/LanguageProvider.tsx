...
export const translations = {
  en: {
    ...
    allUsers: "All users", adminsOnly: "Admins", standardUsersOnly: "Users",
    userManagement: "User Management", userManagementDesc: "Search accounts, inspect activity, and manage access roles.",
    joinedOn: "Joined", userDetail: "User Detail", loadingUsers: "Loading users...", loadingUserDetail: "Loading user detail...",
    deleteUser: "Delete user", deletingUser: "Deleting...", deleteUserTitle: "Delete user",
    deleteUserDesc: "This only works when the account has no linked groups, expenses, or receipts.",
    roleManagement: "Role Management", ownAdminRoleProtected: "Your own admin role is protected from inline changes.",
    roleChangeHint: "Changing role updates access to admin-only areas immediately.", saveRole: "Save role", savingRole: "Saving...",
    ownedGroups: "Owned Groups", pendingSettlementsLabel: "Pending Settlements", totalPaid: "Total Paid",
    groupMemberships: "Group Memberships", noUserGroups: "This user is not in any groups.",
    selectUserToManage: "Select a user to manage the account.",
    ...
    billingProDesc: "Your Pro plan is active with expanded limits and receipt tools.",
    proActive: "Pro Active",
    autoRenew: "Auto-renew Pro plan",
    autoRenewDesc:
      "When enabled, your Pro plan renewal will be prepared automatically for the next cycle.",
    autoRenewEnabled: "Auto-renew is on",
    autoRenewDisabled: "Auto-renew is off",
    included: "Included",
    updatingPlan: "Updating...",
    updateBillingError: "Unable to update billing plan.",
    cancelPlan: "Cancel plan",
    cancelPlanDesc: "Your plan will be set back to Free for testing.",
    remove: "Remove",
    endingIn: "ending in",
    expires: "Expires",
    ...
    deleteAccount: "Delete account", deleteAccountTitle: "Delete account",
    deleteAccountDesc: "This only works when your account has no linked groups, expenses, or receipts.",
  ...
  vi: {
    ...
    allUsers: "Tất cả người dùng", adminsOnly: "Admin", standardUsersOnly: "Người dùng",
    userManagement: "Quản lý người dùng", userManagementDesc: "Tìm tài khoản, xem hoạt động và quản lý quyền truy cập.",
    joinedOn: "Tham gia", userDetail: "Chi tiết người dùng", loadingUsers: "Đang tải người dùng...", loadingUserDetail: "Đang tải chi tiết người dùng...",
    deleteUser: "Xóa người dùng", deletingUser: "Đang xóa...", deleteUserTitle: "Xóa người dùng",
    deleteUserDesc: "Chỉ xóa được khi tài khoản không còn nhóm, chi phí hoặc hóa đơn liên quan.",
    roleManagement: "Quản lý vai trò", ownAdminRoleProtected: "Không thể sửa vai trò admin của chính bạn ngay tại đây.",
    roleChangeHint: "Đổi vai trò sẽ cập nhật quyền vào khu vực admin ngay lập tức.", saveRole: "Lưu vai trò", savingRole: "Đang lưu...",
    ownedGroups: "Nhóm sở hữu", pendingSettlementsLabel: "Thanh toán đang chờ", totalPaid: "Tổng đã trả",
    groupMemberships: "Thành viên các nhóm", noUserGroups: "Người dùng này chưa tham gia nhóm nào.",
    selectUserToManage: "Chọn một người dùng để quản lý tài khoản.",
    ...
    billingProDesc: "Gói Pro của bạn đang hoạt động với giới hạn mở rộng và công cụ hóa đơn.",
    proActive: "Pro đang hoạt động",
    autoRenew: "Tự động gia hạn gói Pro",
    autoRenewDesc:
      "Khi bật, việc gia hạn gói Pro sẽ được chuẩn bị tự động cho chu kỳ tiếp theo.",
    autoRenewEnabled: "Tự động gia hạn đang bật",
    autoRenewDisabled: "Tự động gia hạn đang tắt",
    included: "Đã bao gồm",
    updatingPlan: "Đang cập nhật...",
    updateBillingError: "Không thể cập nhật gói thanh toán.",
    cancelPlan: "Huỷ gói",
    cancelPlanDesc: "Tạm chuyển gói về Free để test.",
    remove: "Xóa",
    endingIn: "số cuối",
    expires: "Hết hạn",
    cardholder: "Chủ thẻ",
