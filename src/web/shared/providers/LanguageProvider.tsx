...
export const translations = {
  en: {
    ...
    markAsPaid: "Mark as Paid", markedPaid: "Marked paid", markAsSent: "Mark as sent", sentLabel: "Sent",
    unableLoadSettlements: "Unable to load settlements.", unableMarkSettlementSent: "Unable to mark the settlement as sent.", loadingSettlementActivity: "Loading activity...", selectedSettlement: "Selected settlement", settlementNotFound: "This settlement is no longer available.",
    ...
    notificationCenterDesc: "Your latest activity and updates.",
    markAllAsRead: "Mark all as read", markingAllAsRead: "Marking as read...",
    closeNotifications: "Close notifications", loadingNotificationList: "Loading notifications...",
    noNotifications: "No notifications yet", noNotificationsDesc: "New group, expense, and payment updates will appear here.",
    unreadNotification: "Unread notification", deleteNotification: "Delete notification", retry: "Retry",
    unreadNotificationCount: "{count} unread notification", unreadNotificationsCount: "{count} unread notifications",
    loadNotificationListError: "Unable to load notifications.",
    markNotificationReadError: "Unable to mark the notification as read.",
    markAllNotificationsReadError: "Unable to mark all notifications as read.",
    deleteNotificationError: "Unable to delete the notification.",
    ...
    currentPlanSectionTitle: "Current Plan",
    proInclusionsTitle: "What Pro includes",
    billingFreeInclusionsTitle: "What you'll get with Pro",
    autoRenewTitle: "Auto-renew Pro plan",
    autoRenewDesc: "When enabled, your Pro plan renewal will be prepared automatically for the next cycle.",
    autoRenewOn: "Auto-renew is on",
    autoRenewOff: "Auto-renew is off",
    autoRenewProOnly: "Auto-renew is available only while Pro is active.",
    billingLimitsTitle: "Plan limits",
    billingExpiryTitle: "Billing expiry",
    billingExpiryDescActive: "Your Pro access is valid for 1 month from successful payment.",
    billingExpiryDescInactive: "No active Pro subscription.",
    billingHistoryTitle: "Billing history",
    billingPurchaseLabel: "Pro plan purchase",
    billingPaidAtLabel: "Paid at",
    billingSuccessLabel: "Success",
    billingNoHistory: "No billing history yet.",
    unlimitedGroups: "Unlimited groups",
    unlimitedExpenses: "Unlimited expenses",
    receiptScanIncluded: "Receipt scan included",
    receiptScanNotIncluded: "Receipt scan not included",
    groupsLimitedTo: "Groups limited to {limit}",
    expensesLimitedTo: "Expenses limited to {limit} {period}",
    unlimitedGroupsAndExpenses: "Unlimited groups and expenses",
    unlimitedGroupsAndExpensesAfterUpgrade: "Unlimited groups and expenses after upgrade",
    receiptScanIncludedBenefit: "Receipt scan is included",
    receiptScanUnlocksWithPro: "Receipt scan unlocks with Pro",
    ...
    paymentReceived: "Payment sent", paymentReceivedDesc: "When a group member marks a payment as sent",
    settlementReminders: "Settlement reminders", settlementRemindersDesc: "Weekly reminders for pending settlements",
    groupInvitesLabel: "Group invites", groupInvitesDesc: "When you are invited to a new group",
    productUpdatesAndTips: "Product updates & tips", productUpdatesAndTipsDesc: "News, feature updates, and tips from Splitly",
  ...
  vi: {
    ...
    markAsPaid: "Đánh dấu đã trả", markedPaid: "Đã đánh dấu trả", markAsSent: "Đánh dấu đã gửi", sentLabel: "Đã gửi",
    unableLoadSettlements: "Không thể tải các khoản thanh toán.", unableMarkSettlementSent: "Không thể đánh dấu khoản thanh toán đã gửi.", loadingSettlementActivity: "Đang tải hoạt động...", selectedSettlement: "Khoản thanh toán được chọn", settlementNotFound: "Khoản thanh toán này không còn tồn tại.",
    ...
    notificationCenterDesc: "Hoạt động và cập nhật mới nhất của bạn.",
    markAllAsRead: "Đánh dấu tất cả đã đọc", markingAllAsRead: "Đang đánh dấu...",
    closeNotifications: "Đóng thông báo", loadingNotificationList: "Đang tải thông báo...",
    noNotifications: "Chưa có thông báo", noNotificationsDesc: "Cập nhật mới về nhóm, chi phí và thanh toán sẽ xuất hiện tại đây.",
    unreadNotification: "Thông báo chưa đọc", deleteNotification: "Xóa thông báo", retry: "Thử lại",
    unreadNotificationCount: "{count} thông báo chưa đọc", unreadNotificationsCount: "{count} thông báo chưa đọc",
    loadNotificationListError: "Không thể tải danh sách thông báo.",
    markNotificationReadError: "Không thể đánh dấu thông báo đã đọc.",
    markAllNotificationsReadError: "Không thể đánh dấu tất cả thông báo đã đọc.",
    deleteNotificationError: "Không thể xóa thông báo.",
    ...
    autoRenewOff: "Tự động gia hạn đang tắt",
    autoRenewProOnly: "Chỉ dùng được khi gói Pro đang hoạt động.",
    billingLimitsTitle: "Giới hạn gói",
    billingExpiryTitle: "Ngày hết hạn gói",
    billingExpiryDescActive: "Quyền dùng Pro của bạn có hiệu lực 1 tháng kể từ khi thanh toán thành công.",
    billingExpiryDescInactive: "Chưa có gói Pro đang hoạt động.",
    billingHistoryTitle: "Lịch sử thanh toán gói",
    billingPurchaseLabel: "Lần mua gói Pro",
    billingPaidAtLabel: "Đã thanh toán lúc",
    billingSuccessLabel: "Thành công",
    billingNoHistory: "Chưa có lịch sử thanh toán.",
    unlimitedGroups: "Không giới hạn nhóm",
    unlimitedExpenses: "Không giới hạn chi phí",
    receiptScanIncluded: "Đã bao gồm quét hóa đơn",
    receiptScanNotIncluded: "Chưa bao gồm quét hóa đơn",
    groupsLimitedTo: "Giới hạn {limit} nhóm",
    expensesLimitedTo: "Giới hạn {limit} chi phí {period}",
    unlimitedGroupsAndExpenses: "Không giới hạn nhóm và chi phí",
    unlimitedGroupsAndExpensesAfterUpgrade: "Không giới hạn nhóm và chi phí sau khi nâng cấp",
    receiptScanIncludedBenefit: "Đã bao gồm quét hóa đơn",
    receiptScanUnlocksWithPro: "Mở khóa quét hóa đơn với Pro",
    ...
    paymentReceived: "Đã gửi tiền", paymentReceivedDesc: "Khi thành viên đánh dấu đã gửi tiền",
    settlementReminders: "Nhắc nhở thanh toán", settlementRemindersDesc: "Nhắc nhở hàng tuần về các khoản chờ thanh toán",
    groupInvitesLabel: "Lời mời nhóm", groupInvitesDesc: "Khi bạn được mời vào nhóm mới",
    productUpdatesAndTips: "Cập nhật sản phẩm & mẹo", productUpdatesAndTipsDesc: "Tin tức, tính năng mới và mẹo từ Splitly",
