...
export const translations = {
  en: {
    ...
    noTransactionsInGroup: "No transactions in this group yet.",
    ...
    cancelSubscriptionConfirm: "Downgrade to the Free plan? You will lose Pro features.",
  ...
  vi: {
    ...
    noTransactionsInGroup: "Nhóm này chưa có giao dịch nào.",
    ...
    cancelSubscriptionConfirm: "Chuyển về gói Miễn phí? Bạn sẽ mất các tính năng của gói Pro.",
    paymentMethodRequiredFields:
